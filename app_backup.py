...
if uploaded_file is not None:
    ...
    if not pdf_bytes:
        ...
        if st.session_state.current_mode == 'edit':
            ...
            try:
                images = erase_mode.pdf_to_images(pdf_bytes)
                ...
                if images:
                    ...
                    display_image = cv2.cvtColor(current_image, cv2.COLOR_BGR2RGB)
                    st.image(display_image, caption=f"Page {st.session_state.current_page + 1}", use_column_width=True)
